...
const CLSTRUCT = 4096;
const CL = { version: 0, flags: 7, csBase: 8, rip: 9, rsp: 10, rbp: 11, rsi: 12, rdi: 13, r8: 14, r9: 15, r10: 16, r11: 17, r12: 18, r13: 19, r14: 20, r15: 21, rax: 22, rbx: 23, rcx: 24, rdx: 25 } as const;
...
class FakeBlinkModule implements BlinkModule {
  ...
  constructor() {
    ...
    let pointer = 8192;
    for (const index of Object.values(CL)) {
